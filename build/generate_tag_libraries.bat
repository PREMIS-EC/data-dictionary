...
echo syntax: generate_tag_libraries.bat (premis) path\to\tei.xml
goto END
...
java -cp vendor\SaxonHE10-2J\saxon-he-10.2.jar net.sf.saxon.Transform -xi:on -s:%2 -xsl:..\transformations\tagLibrary2html.xsl -o:%1.html SAA="yes" currentLanguage="en" currentStandard="premis"
java -cp vendor\SaxonHE10-2J\saxon-he-10.2.jar net.sf.saxon.Transform -xi:on -s:%2 -xsl:..\transformations\tagLibrary2pdf.xsl -o:%1.xml SAA="yes" ISBN="PLACEHOLDER ISBN VALUE" currentLanguage="en" currentStandard="premis"
goto MAIN
