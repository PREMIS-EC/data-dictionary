                ...
                <div class="titlePage">
                        ...
                        <div class="logo">
                              <!--<xsl:apply-templates select="tei:figure/tei:graphic"/> --> 
                                <image src="../images/premis-wiki-1.png" alignment-adjust="middle" />
                        </div>
                        <div>
...
<!--                        <xsl:apply-templates select="tei:div[@type='examples']"/>-->
                ...
                <div class="image">
                        <xsl:element name="img">
                                ...
                                <xsl:attribute name="style">
                                        <xsl:text>max-width: 100%;height: auto;</xsl:text>
                                </xsl:attribute>
                        </xsl:element>
                </div>
        </xsl:template>
        ...
        <xsl:template match="tei:table[@cols='2']">
                ...
                <strong><xsl:value-of select="tei:head"/></strong>
                <br />
                <table style="width:35%;display-align:center" >
                        <tr>
                                <th style="width:50%"/>
        ...
        <xsl:template match="tei:table[@cols='4']">
                ...
                <strong><xsl:value-of select="tei:head"/></strong>
                <br />
                <table style="width:50%;display-align:center" >
                        <tr>
                                <th style="width:25%"/>
                                <th style="width:25%"/>
                                <th style="width:25%"/>
